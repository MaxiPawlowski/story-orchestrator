module.exports = {
  ...
  roots: ["<rootDir>/src/constants", "<rootDir>/src/engine", "<rootDir>/src/extraction", "<rootDir>/src/pacing", "<rootDir>/src/generation", "<rootDir>/src/runtime", "<rootDir>/src/memory", "<rootDir>/src/studio", "<rootDir>/src/copilot", "<rootDir>/src/services"],
  testMatch: ["**/*.test.ts"],
  transform: {
